...
/** Compares the digit sum of two integers according to divisibility, e.g. the digit sum of of 123 is 6 and the digit sum of 47 is 11, hence they are
 * incomparable. */
public enum DigitSumDivisibilityPreorderComparator {
  ...
  public static final BinaryRelation<Integer> BINARY_RELATION = (x, y) -> ((digitSum(y) % digitSum(x)) == 0);
