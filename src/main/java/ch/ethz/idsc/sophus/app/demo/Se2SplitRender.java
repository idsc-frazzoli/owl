...
/** draws geodesics splits in SE(2) */
/* package */ class Se2SplitRender implements RenderInterface {
  ...
  public Se2SplitRender(SymLink symLink) {
  ...
  public void render(GeometricLayer geometricLayer, Graphics2D graphics) {
    if (symLink.isNode())
      return;
    // ---
    new Se2SplitRender(symLink.lP).render(geometricLayer, graphics);
    new Se2SplitRender(symLink.lQ).render(geometricLayer, graphics);
    {
