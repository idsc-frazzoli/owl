...
public enum GeodesicDisplays {
  ...
  public static final List<GeodesicDisplay> SE2C_SE2_S2_H2_R2 = Arrays.asList( //
      ...
      R2GeodesicDisplay.INSTANCE);
  // ---
  public static final List<GeodesicDisplay> SE2C_SE2_SPD2_S2_Rn = Arrays.asList( //
      Se2CoveringGeodesicDisplay.INSTANCE, //
      Se2GeodesicDisplay.INSTANCE, //
      Spd2GeodesicDisplay.INSTANCE, //
      S2GeodesicDisplay.INSTANCE, //
  ...
  public static final List<GeodesicDisplay> SPD2_ONLY = Arrays.asList( //
      Spd2GeodesicDisplay.INSTANCE);
  // ---
  public static final List<GeodesicDisplay> ARRAYS = Arrays.asList( //
      R2GeodesicDisplay.INSTANCE, //
      H2GeodesicDisplay.INSTANCE, //
      S2GeodesicDisplay.INSTANCE, //
      Rp2GeodesicDisplay.INSTANCE);
  // ---
  public static final List<GeodesicDisplay> R2_H2 = Arrays.asList( //
      R2GeodesicDisplay.INSTANCE, //
      H2GeodesicDisplay.INSTANCE);
  public static final List<GeodesicDisplay> R2_H2_S2 = Arrays.asList( //
      R2GeodesicDisplay.INSTANCE, //
      H2GeodesicDisplay.INSTANCE, //
      S2GeodesicDisplay.INSTANCE);
  public static final List<GeodesicDisplay> R2_H2_S2_RP2 = Arrays.asList( //
      R2GeodesicDisplay.INSTANCE, //
      H2GeodesicDisplay.INSTANCE, //
      S2GeodesicDisplay.INSTANCE, //
      Rp2GeodesicDisplay.INSTANCE);
  public static final List<GeodesicDisplay> S2_RP2 = Arrays.asList( //
      S2GeodesicDisplay.INSTANCE, //
      Rp2GeodesicDisplay.INSTANCE);
  // ---
