...
import ch.ethz.idsc.sophus.app.api.IterativeCoordinates;
...
/* package */ class IterativeCoordinateDemo extends A2ScatteredSetCoordinateDemo //
    implements SpinnerListener<GeodesicDisplay> {
  private final List<LogWeighting> array;

  public IterativeCoordinateDemo() {
    this(IterativeCoordinates.list());
  }

  public IterativeCoordinateDemo(List<LogWeighting> array) {
    super(array);
    this.array = array;
    // ---
  ...
  public static void main(String[] args) {
    new IterativeCoordinateDemo().setVisible(1300, 900);
  }
}
