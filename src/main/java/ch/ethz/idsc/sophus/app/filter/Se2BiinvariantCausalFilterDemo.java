  ...
  protected Tensor protected_render(GeometricLayer geometricLayer, Graphics2D graphics) {
    ...
    if (0 < radius) {
      ...
      if (jToggleIIR.isSelected()) {
        ...
        // refined = BiinvariantIIRnFilter.of(geodesicDisplay(), smoothingKernel, radius, alpha()).apply(control());
      } else {
        // refined = BiinvariantFIRnFilter.of(geodesicDisplay(), smoothingKernel, radius, alpha()).apply(control());
