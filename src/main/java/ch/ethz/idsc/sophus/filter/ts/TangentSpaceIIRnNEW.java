...
public class TangentSpaceIIRnNEW implements TensorUnaryOperator {
  ...
  public static TensorUnaryOperator of(GeodesicDisplay geodesicDisplay, ScalarUnaryOperator smoothingKernel, int radius, Scalar alpha) {
    return new TangentSpaceIIRnNEW(//
  ...
  /* package */ TangentSpaceIIRnNEW(GeodesicDisplay geodesicDisplay, ScalarUnaryOperator smoothingKernel, int radius, Scalar alpha) {
