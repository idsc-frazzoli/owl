...
public class ClothoidTerminalRatios2 implements Serializable {
  ...
  public static Scalar head(Tensor p, Tensor q) {
    Tensor tensor = Nest.of(HEAD, Tensor.of(Stream.of(p, q)), ITERATIONS);
  ...
  public static Scalar tail(Tensor p, Tensor q) {
    Tensor tensor = Nest.of(TAIL, Tensor.of(Stream.of(p, q)), ITERATIONS);
