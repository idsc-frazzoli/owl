...
public class BezierExtrapolation implements TensorUnaryOperator {
  ...
  public static TensorUnaryOperator of(SplitInterface splitInterface) {
    return new BezierExtrapolation(splitInterface);
  }

  // ---
  private final SplitInterface splitInterface;

  private BezierExtrapolation(SplitInterface splitInterface) {
  ...
  public Tensor apply(Tensor tensor) {
    int n = tensor.length();
    return BezierFunction.of(splitInterface, tensor).apply(RationalScalar.of(n, n - 1));
  }
