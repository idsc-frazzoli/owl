...
public class DeCasteljauTest extends TestCase {
  public void testSimple() {
    ...
    DeCasteljau curve = new DeCasteljau(RnGeodesic.INSTANCE);
    Tensor result = curve.of(points, scalar);
  ...
  public void testSe2Covering() {
    ...
    Scalar scalar = RationalScalar.of(1, 4);
    DeCasteljau curve = new DeCasteljau(Se2CoveringGeodesic.INSTANCE);
    Tensor result = curve.of(points, scalar);
