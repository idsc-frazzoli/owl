...
public class GeodesicPursuitTest extends TestCase {
  public void test() {
    ...
    // System.out.println("ratio 1 = " + (ratio1.isPresent() ? ratio1.get() : "empty"));
    ...
    // System.out.println("ratio 2 = " + (ratio2.isPresent() ? ratio2.get() : "empty"));
    if (geodesicPursuit.ratio().isPresent())
