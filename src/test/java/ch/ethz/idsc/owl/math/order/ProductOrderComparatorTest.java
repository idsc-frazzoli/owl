...
public class ProductOrderComparatorTest extends TestCase {
  ...
  public void testTensorSimple() {
    OrderComparator<Scalar> orderComparator = ScalarTotalOrder.INSTANCE;
    List<OrderComparator> comparators = Arrays.asList( //
        orderComparator, //
        orderComparator, //
        orderComparator); //
  ...
  public void testTotalProduct() {
    ...
    comparatorList.add(comparator1);
    comparatorList.add(comparator1);
    ProductOrderComparator genericProductOrderComparator = new ProductOrderComparator(comparatorList);
