...
public class LimitedClothoidNdTypeTest extends TestCase {
  public void testSimple() {
    ...
    Scalar scalar = ndCenterInterface.ofVector(Tensors.vector(0, 1, 0));
  ...
  public void testQuantity() {
    ...
    assertEquals(ndCenterInterface.ofVector(Tensors.fromString("{2[m], 2[m], 0}")), Quantity.of(2, "m"));
    assertEquals(ndCenterInterface.ofVector(Tensors.fromString("{0[m], 2.1[m], 0}")), Quantity.of(Double.POSITIVE_INFINITY, "m"));
  }
}
