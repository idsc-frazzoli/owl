...
public class BalloonEntityTest extends TestCase {
  ...
  public void testCreateTrajectoryPlanner() {
    ...
    BalloonEntity balloonEntity = createEntity();
    GlcTrajectoryPlanner trajectoryPlanner = balloonEntity.createTrajectoryPlanner(plannerConstraint, goal);
    assertTrue(trajectoryPlanner instanceof StandardGlcTrajectoryPlanner);
