...
public class Se3DifferencesTest extends TestCase {
  public void testSimple() {
    Tensor m1 = Se3Utils.toMatrix4x4(Rodrigues.exp(Tensors.vector(0.2, -0.3, 0.4)), Tensors.vector(10, 20, 30));
    Tensor m2 = Se3Utils.toMatrix4x4(Rodrigues.exp(Tensors.vector(-0.2, 0.3, 0.4)), Tensors.vector(11, 21, 31));
