...
public class Se2BiinvariantMeanTest extends TestCase {
  ...
  public void testArsignyPennec() {
    ...
    Tensor actualUnordered = Se2BiinvariantMean.DEFAULT.mean(sequenceUnordered, weights);
    // ---
  ...
  public void testTrivial() {
    ...
    Tensor actual = Se2BiinvariantMean.DEFAULT.mean(p, weights);
  ...
  public void testOrderInvariance() {
    ...
    Tensor weights = Tensors.vector(1, 1, 1).divide(RealScalar.of(3));
    Tensor actual1 = Se2BiinvariantMean.DEFAULT.mean(sequence1, weights);
    Tensor actual2 = Se2BiinvariantMean.DEFAULT.mean(sequence2, weights);
    Tensor actual3 = Se2BiinvariantMean.DEFAULT.mean(sequence3, weights);
  ...
  public void testFail() {
    ...
    try {
      ...
      Se2BiinvariantMean.DEFAULT.mean(sequence, weights);
      fail();
