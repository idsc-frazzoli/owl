...
public class RnHermite3A1SubdivisionTest extends TestCase {
  public void testString() {
    Tensor control = Tensors.fromString("{{0, 0}, {1, 0}, {0, -1}, {-1/2, 1}}");
    TensorIteration tensorIteration = RnHermite3A1Subdivision.instance().string(RealScalar.ONE, control);
  ...
  public void testStringReverse() {
    ...
    TensorIteration ti1 = RnHermite3A1Subdivision.instance().string(RealScalar.ONE, cp1);
    TensorIteration ti2 = RnHermite3A1Subdivision.instance().string(RealScalar.ONE, Reverse.of(cp2));
  ...
  public void testCyclic() {
    Tensor control = Tensors.fromString("{{0, 0}, {1, 0}, {0, -1}, {-1/2, 1}}");
    TensorIteration tensorIteration = RnHermite3A1Subdivision.instance().cyclic(RealScalar.ONE, control);
    Tensor tensor = tensorIteration.iterate();
    ExactTensorQ.require(tensor);
  ...
  public void testPolynomialReproduction() {
    HermiteSubdivision hermiteSubdivision = RnHermite3A1Subdivision.instance();
    Tensor coeffs = Tensors.vector(2, -7);
