...
public class Hermite3SubdivisionA1Test extends TestCase {
  public void testMatchString() {
    ...
    for (int length = 4; length < 6; ++length) {
      ...
      TensorIteration ti2 = Hermite3SubdivisionA1.of(RnGroup.INSTANCE, RnExponential.INSTANCE, RnBiinvariantMean.INSTANCE) //
