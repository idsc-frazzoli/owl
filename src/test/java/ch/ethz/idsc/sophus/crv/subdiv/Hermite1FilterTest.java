...
public class Hermite1FilterTest extends TestCase {
  public void testR1PolynomialReproduction() {
    ...
    Hermite1Filter hermite1Filter = new Hermite1Filter(RnGroup.INSTANCE, RnExponential.INSTANCE);
    TensorIteration tensorIteration = hermite1Filter.string(RealScalar.ONE, control);
