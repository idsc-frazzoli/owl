...
public class RnHermite3SubdivisionTest extends TestCase {
  ...
  public void testStringReverse() {
    ...
    TensorIteration ti1 = RnHermite3Subdivision.common().string(RealScalar.ONE, cp1);
    TensorIteration ti2 = RnHermite3Subdivision.common().string(RealScalar.ONE, Reverse.of(cp2));
  ...
  public void testCyclic() {
    Tensor control = Tensors.fromString("{{0, 0}, {1, 0}, {0, -1}, {-1/2, 1}}");
    TensorIteration tensorIteration = RnHermite3Subdivision.common().cyclic(RealScalar.ONE, control);
    Tensor tensor = tensorIteration.iterate();
    ExactTensorQ.require(tensor);
  ...
  public void testPolynomialReproduction() {
    HermiteSubdivision hermiteSubdivision = new RnHermite3Subdivision( //
  ...
  public void testMatrices() {
    ...
    RnHermite3Subdivision rnHermite3Subdivision = (RnHermite3Subdivision) RnHermite3Subdivision.common();
  ...
  public void testSpecialCase() {
    RnHermite3Subdivision rnHermite3Subdivision = new RnHermite3Subdivision(RealScalar.ZERO, RealScalar.ZERO);
