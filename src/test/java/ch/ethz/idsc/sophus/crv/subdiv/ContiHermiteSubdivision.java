...
/* package */ class ContiHermiteSubdivision {
  ...
  public static HermiteSubdivision string(Tensor control) {
    return new ContiHermiteSubdivision(control).new StringIteration();
  }

  public static HermiteSubdivision cyclic(Tensor control) {
    return new ContiHermiteSubdivision(control).new CyclicIteration();
  }
  ...
  private ContiHermiteSubdivision(Tensor control) {
